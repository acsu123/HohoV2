...
do	
	...
	Hover.ImageColor3 = Color3.fromRGB(50, 255, 50)
	...
	Wallpaper.Image = "rbxassetid://137514377554215"
	...
	Status.Text = "Quando você quer alguma coisa, todo o universo conspira para que você consiga."
	...
	UIGradient.Color = ColorSequence.new{ ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 205, 50)), ColorSequenceKeypoint.new(0.466321, Color3.fromRGB(40, 180, 40)), ColorSequenceKeypoint.new(0.797927, Color3.fromRGB(30, 100, 30)), ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 30, 30)) }
	...
	Logo.Name = "Logo"
	Logo.Image = "rbxassetid://83249670401947"
	...
	Main.Image = "rbxassetid://83249670401947"
	...
	Content.BackgroundColor3 = Color3.fromRGB(50, 205, 50)
	...
	ImageLabel.ImageColor3 = Color3.fromRGB(50, 255, 50)
	...
	Logo_1.Name = "Logo"
	Logo_1.Image = "rbxassetid://83249670401947"
	...
	Get.TextScaled = true
	Get.BackgroundColor3 = Color3.fromRGB(34, 139, 34)
	...
	UIStroke_1.Color = Color3.fromRGB(50, 205, 50)
	...
	Submit.BackgroundColor3 = Color3.fromRGB(34, 139, 34)
	...
	UIStroke_2.Color = Color3.fromRGB(50, 205, 50)
  ...
  Get2.Title.Text = "How To Get Key"
	...
	Pfp.Name = "Pfp"
	Pfp.Image = "rbxassetid://129011416637455"
	...
	Support.BackgroundColor3 = Color3.fromRGB(50, 205, 50)
	...
	UIStroke_3.Color = Color3.fromRGB(50, 205, 50)
	...
	Title_2.TextColor3 = Color3.fromRGB(50, 205, 50)
	...
	Credit.Text = [[<font color="rgb(50,205,50)">BR</font> VERSION | <font color="#5d6af2">DISCORD</font> .gg/hоhоhub]]
	...
	Close.BackgroundColor3 = Color3.fromRGB(50, 205, 50)
	...
	Title_3.TextColor3 = Color3.fromRGB(50, 205, 50)
	...
	UIStroke_4.Color = Color3.fromRGB(50, 205, 50)
	...
	UIGradient_2.Color = ColorSequence.new(Color3.fromRGB(50, 205, 50))
	...
	UIStroke_6.Color = Color3.fromRGB(50, 205, 50)
	...
	UIGradient_1.Color = ColorSequence.new{ ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 205, 50)), ColorSequenceKeypoint.new(0.468048, Color3.fromRGB(30, 100, 30)), ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 30, 30)) }
	...
	UIGradient_4.Color = ColorSequence.new{ ColorSequenceKeypoint.new(0, Color3.fromRGB(34, 139, 34)), ColorSequenceKeypoint.new(0.531952, Color3.fromRGB(25, 80, 25)), ColorSequenceKeypoint.new(1, Color3.fromRGB(18, 45, 18)) }
	...
	for i,v in pairs({Get,Submit,Close,Support}) do
		if isNotLocked(v) then
			if v == Get or v == Submit then
				...
				v.MouseLeave:Connect((function()
					TweenService:Create(v,INFO_DOT25_QUAD,{BackgroundTransparency = 1}):Play()
					TweenService:Create(v["Title"],INFO_DOT25_QUAD,{TextColor3 = Color3.fromRGB(50, 205, 50)}):Play()
				end))
			end
		end
	end
